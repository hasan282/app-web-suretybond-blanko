<?php $ofiice = get_user_office($this->session->userdata('id'));
$principal = $this->db->query('SELECT id AS num, nama FROM principal WHERE id_office = ? ORDER BY nama ASC', $ofiice->id)->result_array();
$obligee = $this->db->query('SELECT id AS num, nama FROM obligee WHERE id_office = ? ORDER BY nama ASC', $ofiice->id)->result_array();
$princ_data = [];
$obli_data = [];
                ...
                <div class="card-body pt-2">
                    ...
                    <div class="form-group mw-300">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="prefix" name="prefix_now" value="<?= $blanko['prefix']; ?>">
                            <input type="text" class="form-control" value="<?= $blanko['nomor']; ?>" readonly>
                        </div>
                        <input type="hidden" name="prefix_old" value="<?= $blanko['prefix']; ?>">
                    </div>
                    ...
                    <div class="border-fade pt-3 pr-3">
                        ...
                        <div class="form-group row ml-xl-0 ml-2">
                            <label for="tanggal" class="col-xl-4 col-form-label text-xl-right">Mulai Tanggal</label>
                            <div class="input-group date col-xl-8" id="tanggal" data-target-input="nearest">
                                <div class="input-group-prepend" data-target="#tanggal" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar-alt"></i></div>
                                </div>
                                <input type="hidden" id="val_tanggal" value="2022-02-28" name="tanggal">
                    ...
                    <!-- 
                    <div class="form-group">
                        <label for="keterangan">Keterangan <small>(jika ada)</small></label>
