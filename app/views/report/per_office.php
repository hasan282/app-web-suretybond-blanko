        ...
        <table class="table table-hover text-nowrap">
            <thead>
                <tr>
                    ...
                    <th class="border-right">Nama Pemegang Blanko</th>
            ...
            <tbody>
                ...
                foreach ($report as $key => $rp) :
                    ...
                    <tr class="tr-link officelink" data-direct="<?= urlencode(self_encrypt($rp['id'])); ?>">
                        <td class="text-center text-bold"><?= $key + 1; ?></td>
                        <td class="border-right"><?= $rp['office']; ?></td>
...
<?php $direct_to = (isset($direct)) ? $direct : 'report/agent?var='; ?>
<script>
    $(function() {
        $('.officelink').on('click', function() {
            window.location.href = '<?= base_url($direct_to); ?>' + $(this).data('direct');
        });
    });
</script>