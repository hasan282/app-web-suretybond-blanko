$(function () {
    ...
    table_setup({
        ...
        option_button: '<a href="' + base_url('revision/b/$enkrip') + '" class="btn btn-secondary btn-sm text-bold">Revisi<i class="fas fa-sync-alt ml-2"></i></a><a href="' + base_url('blanko/detail/$enkrip') + '" class="btn btn-info ml-2 btn-sm text-bold"><i class="fas fa-info-circle"></i></a>'
    });
